/* silveracorn.nz MXUI website - Version MX_2.2.1 - 1-Mar-2021 */
/*
...
LANG.FR = {
    ...
    feelslike_title   : "Se sent comme",
    feelslike_info    : "Se sent comme Température",
    feelslike_web     : "Se sent comme",
...
LANG.DE = {
    ...
    apptemp_web       : 'Gefühlt',
    feelslike_title   : "Gefühlt wie",
    feelslike_info    : "Gefühlte wie Temperatur",
    feelslike_web     : "Gefühlt wie",
...
LANG.NL = {
    ...
    apptemp_web       : 'Gevoel',
    feelslike_title   : "Voelt als",
    feelslike_info    : "Voelt als temperatuur",
    feelslike_web     : "Voelt als",
    chill_title       : "Wind Koude",
    chill_info        : "Wind Koude",
    chill_web         : "Wind Koude",
...
LANG.SE = {
    ...
    apptemp_web       : 'Upplevd',
    feelslike_title   : "Feels Like",
    feelslike_info    : "Feels Like temperatur",
    feelslike_web     : "Feels Like",
...
LANG.DK = {
    ...
    apptemp_web       : 'Komfort',
    feelslike_title   : "føles som",
    feelslike_info    : "føles som temperatur",
    feelslike_web     : "føles som",
...
LANG.FI = {
    ...
    feelslike_title   : "Feels Like",
    feelslike_info    : "Feels Like Temperature",
    feelslike_web     : "Feels Like",
...
LANG.NO = {
    ...
    apptemp_web       : 'Følt',
    feelslike_title   : "FÃ¸lt temp.",
    feelslike_info    : "FÃ¸lt temperatur",
    feelslike_web     : "FÃ¸lt temp.",
...
//======================================================================================================================
    ...
    windruntoday      : "Vindstrekning i dag",
    uv_title          : "UV Indeks",
    uv_levels         : ["Ingen", "Ingen fare", "Liten risiko", "Høy risiko", "Veldig høy risiko", "Ekstrem risiko"],
    uv_headlines: [
        "Ingen målbar UV Indeks",
        "Ingen fare for en 'gjennomsnittlig' person",
        "Liten risiko for skade fra ubeskyttet soling",
        "Høy risiko for skade fra ubeskyttet soling",
        "Svært høy risiko for skade fra ubeskyttet soling",
    ...
    uv_details: [
        "Det er fortsatt natt - eller det er en veldig overskyet dag.",
        "Bruk solbriller på lyse dager, bruk solkrem hvis det er snø på bakken,<br>som reflekterer UV-stråling - hvis du ikke har spesielt god hud.",
        "Bruk solbriller og SPF30 + solkrem, dekk kroppen med klær og<br>en lue, søk skygge midt på dagen når solen er mest intens.",
        "Bruk solbriller og SPF30 + solkrem, dekk kroppen med solbeskyttende<br>klær og en skyggelue, reduser tid i solen fra to timer før<br>til tre timer etter at solen er på det høyeste (ca 11:00 til 16:00 om sommeren i<br>(soner som bruker sommertid).",
        "Bruk SPF30 + solkrem, en skjorte, solbriller og solhatt.<br>Ikke være ute i solen for lenge.",
        "Ta alle forholdsregler, inkludert: bruk av solbriller samt bruk SPF30 + solkrem,<br>dekk kroppen med en langermet skjorte og bukse, bruk skyggelue og<br>unngå solen fra to timer før til tre timer etter at solen er på det høyeste (ca 11:00<br>til 16:00 om sommeren i soner som bruker sommertid).",
    ],
    solar_title       : "Solstråling",
    solar_currentMax  : "Nåværende teoretiske maksimale måling",
    solar_ofMax       : "av maksimalt",
    ...
    cloudbase_popup_text:
        "Beregningen er en enkel en: 300 meter for hver 2,5 grader Celsius<br>forskjell mellom temperaturen og duggpunktet. Legg merke til at dette<br>gir bare den teoretiske høyden hvor cumulusskyer ville begynne å dannes, <br>når luften er mettet.",
    feet              : "fot",
    metres            : "meter",
    miles             : "mil",
    n_miles           : "n.mil",
...
LANG.NN = {
    canvasnosupport:
        "Nettlesar stør ikkje HTML5 Canvas-støtte ... Orsak ...<br>Oppgradere nettlesaren til ein nyare versjon - nesten alle nettlsarar støtter Canvas nå, sjølv IE9!<br><br>Omdirigerer deg til den 'gamle' sida for Instrument ...",
    ...
    apptemp_info      : "Opplevd temperatur",
    apptemp_web       : "Opplevd",
    feelslike_title   : "Følt temp.",
    feelslike_info    : "Følt temp.",
    feelslike_web     : "Følt temp.",
    chill_title       : "Vindfaktor",
    chill_info        : "Vindfaktor",
    chill_web         : "Vindfaktor",
    heat_title        : "Varmeindeks",
    ...
    windruntoday      : "Vindstrekning i dag",
    uv_title          : "UV Indeks",
    uv_levels         : ["Inga", "Inga fare", "Liten risiko", "Høg risiko", "Veldig høg risiko", "Ekstrem risiko"],
    uv_headlines: [
        "Ingen målbar UV Indeks",
    ...
    uv_details: [
        "Det er fortsatt natt - eller det er ein mykje overskya dag.",
        "Bruk solbriller på lyse dagar, bruk solkrem dersom det er snø på bakken,<br>som reflekterer UV-stråling - om du ikkje har spesiell god hud.",
        "Bruk solbriller og SPF30 + solkrem, dekk kroppen med klær og<br>ein lue, søk skygge midt på dagen når solen er mest intens.",
        "Bruk solbriller og SPF30 + solkrem, dekk kroppen med solbeskyttende<br>klær og ein skyggelue, reduser tid i sola frå to timer før<br>til tre timar etter at sola er på det høgaste (ca 11:00 til 16:00 om sommeren i<br>(soner som bruker sommertid).",
        "Bruk SPF30 + solkrem, en skjorte, solbriller og solhatt.<br>Ikke være ute i solen for lenge.",
        "Ta alle forholdsregler, inkludert: bruk av solbriller samt bruk SPF30 + solkrem,<br>dekk kroppen med ein langermet skjorte og bukse, bruk skyggelue og<br>unngå sola frå to timer før til tre timer etter at sola er på det høyeste (ca 11:00<br>til 16:00 om sommaren i soner som bruker sommartid).",
    ],
    solar_title       : "Solstråling",
    ...
    cloudbase_popup_text:
        "Berekninga er enkel: 300 meter for kvar 2,5 gradar Celsius<br>skilnad mellom temperaturen og doggpunktet. Ver merksam at dette<br>berre gjev den teoretiske høgda der cumulusskyar vert danna <br>når lufta er metta.",
    feet              : "fot",
    metres            : "meter",
    miles             : "mil",
    n_miles           : "n.mil",
...
LANG.IT = {
    ...
    feelslike_title   : "Percepita",
    feelslike_info    : "Temp. Percepita",
    feelslike_web     : "Temp. Percepita",
    chill_title       : 'Wind Chill',
    chill_info        : 'Wind Chill',
    chill_web         : 'Wind Chill',
...
LANG.ES = {
    ...
    feelslike_title   : "Feels Like",
    feelslike_info    : "Temperatura Feels Like",
    feelslike_web     : "Feels Like",
...
LANG.CS = {
    ...
    feelslike_title   : "Feels Like",
    feelslike_info    : "Feels Like teplota",
    feelslike_web     : "Feels Like",
