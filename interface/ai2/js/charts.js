...
//    });
    $('.ows-btnBar').children().on('click', function(){
        $('.ows-btnBar').children().removeClass('w3-disabled'); //  Enable all buttons
        $('#' + this.id).addClass('w3-disabled');               //  Disable this button
    ...
    .then((results) => {
        ...
        $('#' + currentChart).addClass('w3-disabled');
