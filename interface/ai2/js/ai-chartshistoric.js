/*	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * 	Script:	ai-chartshistoric.js	| Ver: 5.0.0
...
$(document).ready(() => {
    ...
    .then(function (results) {
        ...
        var currentChart = cmxSession.Charts.Historic;
        if( currentChart == '') { currentChart = 'temp';}
        $('#'+ currentChart).addClass('ow-disabled');
        doGraph( currentChart );
    });
