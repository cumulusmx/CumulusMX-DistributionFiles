/*  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    Last Edit (NT): 2026-08-11 09:52:51
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
$(document).ready(function () {
	...
	function formatDateTime( aTime ) {
		...
		var tim;
		tim = ('' + d.getHours()).padStart(2,'0') + ':' + ('' + d.getMinutes()).padStart(2,'0') ;
		tim += ' <span class="ow-even-smaller ow-italic">on</span> ';
...
let showData = function( data) {
	$('#availableData').removeClass('ow-hide');
