...
$(document).ready(function() {
    ...
    .done(function(result) {
        ...
        var columnDefs = [
            ...
            {title: '{{WIND_LATEST}}', type: 'number', min: 0, step: windGustStep},
            ...
            {title: '{{SEA_LEVEL_PRESSURE}}', type: 'number', min: pressMin, max: pressMax, step: pressStep},
            ...
            {title: '{{SOLAR_MAX}}', type: 'number', min: 0, max: 1200},
