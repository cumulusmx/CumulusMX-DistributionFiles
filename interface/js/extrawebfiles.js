...
$(document).ready(function () {
    ...
    $('#filesForm').alpaca({
        dataSource: '/api/settings/extrawebfiles.json',
        optionsSource: '/json/ExtraWebFilesOptions.json',
        schemaSource: '/json/ExtraWebFilesSchema.json',
        ui: 'bootstrap',
        view: 'bootstrap-edit',
        options: {
            form: {
                    ...
                    validate: {
                        ...
                        click: function() {
                            ...
                            if (this.isValid(true)) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/api/setsettings/updateextrawebfiles.json',
