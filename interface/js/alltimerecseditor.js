// Last modified: 2021/10/14 14:37:40
...
$(document).ready(function() {
    ...
    $.ajax({url: "api/edit/alltimerecords.json", dataType:"json", success: function (result) {
        $.each(result, function(key, value) {
            $('#' + key).text(value);
        });
    }});

    $.ajax({url: "api/edit/alltimerecordsdayfile.json", dataType:"json", success: function (result) {
        $.each(result, function(key, value) {
            $('#' + key).text(value);
        });
    }});
    ...
    $(document).ajaxStop(function() {
        ...
        $('#lowFeelsLikeTime').editable({format:"dd/mm/yyy hh:ii"});
        ...
        $('#highMinTempTime').editable({format:"dd/mm/yyyy"});
        $('#lowMaxTempVal').editable();
        $('#lowMaxTempTime').editable({format:"dd/mm/yyyy"});
